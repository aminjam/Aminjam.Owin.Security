...
namespace Aminjam.Owin.Security.Fitbit
{
    ...
    public class FitbitAuthenticationMiddleware : AuthenticationMiddleware<FitbitAuthenticationOptions>
    {
        ...
        /// <summary>
        /// Initializes a <see cref="FitbitAuthenticationMiddleware"/>
        /// </summary>
        ...
        /// </summary>
        /// <returns>An <see cref="AuthenticationHandler"/> configured with the <see cref="FitbitAuthenticationOptions"/> supplied to the constructor.</returns>
        ...
        private static HttpMessageHandler ResolveHttpMessageHandler(FitbitAuthenticationOptions options)
        {

...
{
    /// <summary>
    /// Configuration options for <see cref="GlassAuthenticationMiddleware"/>
    /// </summary>
    public class GlassAuthenticationOptions : AuthenticationOptions
    {
        /// <summary>
        /// Initializes a new <see cref="GlassAuthenticationOptions"/>
        /// </summary>
            ...
            : base(Constants.DefaultAuthenticationType)
        {
            ...
            CallbackPath = new PathString("/signin-glass");
        ...
        /// <summary>
        /// Gets or sets the <see cref="IGlassAuthenticationProvider"/> used to handle authentication events.
        /// </summary>
        ...
        /// <summary>
        /// A list of permissions to request seperated by comma
        /// </summary>
